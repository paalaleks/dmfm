...
import { RiSkipLeftFill, RiSkipRightFill } from '@remixicon/react';
            ...
            <div className='flex justify-center items-center gap-1'>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  >
                    <RiSkipLeftFill className='!h-6 !w-6' />
                  </Button>
                </TooltipTrigger>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    disabled={!isReady || !player || !deviceId || tasteMatchedPlaylists.length < 2}
                  >
                    <RiSkipRightFill className='!h-6 !w-6' />
                  </Button>
                </TooltipTrigger>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      disabled={
                        !isReady || !player || !currentTrack || isCurrentTrackSaved === null
                      }
                    >
                      <Heart
                        className='h-4 w-4'
