...
- Adhere to project structure (`ai/docs/project-structure.md`) and coding standards (`ai/docs/coding-standards.md`)
...
2. **Implementation**
   ...
   - Follow coding standards from `ai/docs/coding-standards.md`

3. **Testing**

   - Implement tests as specified in story requirements following `ai/docs/testing-strategy.md`
