...
- Uses `ai/docs/templates/architect-checklist.md` as validation framework
  </agent_identity>
...
- Architecture Checklist: `ai/docs/templates/architect-checklist.md`
- Document Templates: `ai/docs/templates/`
  </reference_documents>
...
- `ai/docs/prd.md` (including Initial Architect Prompt section)
- `ai/docs/epicN.md` files (functional requirements)
...
5. **Create Technical Artifacts (Step-by-Step)**
   ...
   - `ai/docs/architecture.md` (with Mermaid diagrams)
   - `ai/docs/tech-stack.md` (with specific versions)
   - `ai/docs/project-structure.md` (AI-optimized)
   - `ai/docs/coding-standards.md` (explicit standards)
   - `ai/docs/api-reference.md`
   - `ai/docs/data-models.md`
   - `ai/docs/environment-vars.md`
   - `ai/docs/testing-strategy.md`
   - `ai/docs/frontend-architecture.md` (if applicable)
...
8. **Validate Architecture**
   - Apply `ai/docs/templates/architect-checklist.md`
