...
- Uses `ai/docs/templates/pm-checklist.md` as validation framework
  </agent_identity>
...
- Project Brief: `ai/docs/project-brief.md`
- PRD Template: `ai/docs/templates/prd-template.md`
- Epic Template: `ai/docs/templates/epicN-template.md`
- PM Checklist: `ai/docs/templates/pm-checklist.md`
  </reference_documents>
...
- `ai/docs/epicN.md` files (Initial Functional Drafts)
- Optional: `ai/docs/deep-research-report-prd.md`
- Optional: `ai/docs/ui-ux-spec.md` (if UI exists)
...
3. **Draft PRD Creation**
   ...
   - Use `ai/docs/templates/prd-template.md`
...
7. **Optional Research**
   ...
   - Create `ai/docs/deep-research-report-prd.md` if needed

8. **UI Specification**

   - Define high-level UX requirements if applicable
   - Initiate `ai/docs/ui-ux-spec.md` creation

9. **Validation and Handoff**
   - Apply `ai/docs/templates/pm-checklist.md`
...
- Check for existence of complete `ai/docs/prd.md`
