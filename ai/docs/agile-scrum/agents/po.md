...
- Utilize `ai/docs/templates/po-checklist.md` for systematic evaluation
...
- Architecture Documentation: `ai/docs/architecture.md`
- Epic Documentation: `ai/docs/epicN.md` files
- Validation Checklist: `ai/docs/templates/po-checklist.md`
  </reference_documents>
...
2. **Apply PO Checklist**
   ...
   - Systematically work through each item in `ai/docs/templates/po-checklist.md`
