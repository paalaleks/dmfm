...
- **Pattern 1:** {e.g., Serverless, Event-Driven, Microservices, CQRS} - _Rationale/Reference:_ {Briefly why, or link to `ai/docs/architecture.md` section}
...
- **File Structure:** Adhere to the layout defined in `ai/docs/project-structure.md`.
...
- **Comments & Documentation:** {Expectations for code comments, ai/docstrings, READMEs.}
...
- Secrets Management: {How are secrets handled in code? Reference `ai/docs/environment-vars.md` regarding storage.}
