...
*   **Developer-Led Manual Testing:** As features are developed, the developer(s) will manually test the functionality to ensure it meets the requirements outlined in the PRD (`ai/docs/prd.md`). This includes:
