...
As per `ai/docs/project-structure.md`, Server Actions will be co-located within the `app/` directory (e.g., `app/_actions/chat-actions.ts`) or in a dedicated `lib/actions/` directory.
